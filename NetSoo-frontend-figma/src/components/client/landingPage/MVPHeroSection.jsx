...
const MVPHeroSection = () => {
  return (
    <div className="text-white py-16 px-4 ">
      <div className="max-w-5xl mx-auto text-center">
        <div className="inline-block bg-[#FFFFFF0A] rounded-[40px] px-2 md:px-6 py-2 mb-6 border border-[#FFFFFF0A]">
        ...
        <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
          Plan Smarter. Post Faster. Grow Confidently.
        </h1>

        <p className="text-white/60 text-lg mb-12 max-w-3xl mx-auto">
          Automate your posts, analyze performance, and simplify your social
          media tasks all in one clean dashboard.
        </p>
      </div>
      <div className="text-center">
        ...
        <p className="text-white/80">No setup. No credit card. Just results.</p>
